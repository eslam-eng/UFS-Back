...
class OutReceiptController extends ReceiptController
{
    public function index()
    {
        $query = Receipt::where('type', 'out')->with(['store','company','expenseType']);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            watch(__('add out receipt ').$resource->name,'fa fa-file');
    ...
    public function update(Request $request, Receipt $resource)
    {
        ...
        try {
            ...
            watch(__('update out receipt ').$resource->name,'fa fa-file');
    ...
    {
        try {
            watch(__('delete out receipt ').$resource->name,'fa fa-trash');
            $resource->delete();
