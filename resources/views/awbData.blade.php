...
<table class="w3-table w3-table-bordered" >
    <tr >
        ...
        <td style="width: 32%;padding-top: 0px"  > 
            ...
            <div class="w3-indigo w3- w3-center w3-border w3-border-gray w3-padding"  >
            ...
            <div class="w3- w3-border w3-border-gray" style="padding: 3px;height: 278px" >
...
<div class="w3-padding" style="padding-top: 0px" >
...
<div class="w3-center" >www.ufs-eg.com</div>
